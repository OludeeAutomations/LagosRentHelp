...
const AgentProfile: React.FC = () => {
  ...
  // Calculate agent rating (mock data)
  const agentRating = 4.7;
        ...
        <motion.div
          ...
          <Card className="border-gray-200">
            <CardHeader>
              ...
              <CardDescription className="text-gray-600">
                Current status of {agent.userId}'s property portfolio
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <Progress
                  value={
                    (availableProperties.length / agentProperties.length) * 100
                  }
                ...
                <Progress
                  value={
                    (pendingProperties.length / agentProperties.length) * 100
                  }
                  className="h-2 bg-gray-200"
                />
              </div>
            ...
            <TabsContent value="reviews" className="pt-6">
              <Card className="border-gray-200">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-600">
                    What clients are saying about {agent.userId}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {agent.totalReviews === 0 ? (
                    ...
                    <div className="space-y-6">
                      <div className="border-b border-gray-200 pb-6 last:border-0 last:pb-0">
                        ...
                        <p className="text-gray-600">
                          {agent.userId} was very professional and helped me
